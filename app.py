...
async def hello_world(request):
    return redirect("https://shiro.wtf")



async def _extract_color(buffer: BytesIO):
    try:
...
async def extract_color(url: str):
    ...
    color = await _extract_color(buffer)
    return color


#@app.before_request
#async def before_request(request):
#    if not request.headers.get("Authorization", "") == "auth":
...
async def recenttracks(request):
    username = request.args.get("username") or request.args.get("user")
    if not username:
        raise ValueError("Parameter 'username' is required.")
...
async def toptracks(request, username: str, period: str = "overall", limit: int = 10):
    """
    Get a Last.fm user's top tracks
    """
    username = request.args.get("username") or request.args.get("user")
    if not username:
        raise ValueError("Parameter 'username' is required.")
...
async def artist_search(request):
    username = request.args.get("username") or request.args.get("user")
    if not username:
        raise ValueError("Parameter 'username' is required.")
...
async def album_search(request):
    username = request.args.get("username") or request.args.get("user")
    if not username:
        raise ValueError("Parameter 'username' is required.")
...
async def track_search(request):
    username = request.args.get("username") or request.args.get("user")
    if not username:
        raise ValueError("Parameter 'username' is required.")
...
async def library_artists(request):
    username = request.args.get("username") or request.args.get("user")
    if not username:
        raise ValueError("Parameter 'username' is required.")
...
async def library_albums(request):
    username = request.args.get("username") or request.args.get("user")
    if not username:
        raise ValueError("Parameter 'username' is required.")
...
async def library_tracks(request):
    username = request.args.get("username") or request.args.get("user")
    if not username:
        raise ValueError("Parameter 'username' is required.")
...
def replace_size(size: str, request: bool = False):
    if "x" not in size:
        raise ValueError("Collage size invalid")
    if not len(size.split("x")) == 2:
        raise ValueError("Collage size invalid")
    row, col = size.split("x")
    if not row.isdigit() or not col.isdigit(request):
        raise ValueError("Collage size invalid")
